          ...
          {row.map(key => {
            ...
            return (
              <button
                ...
                className={cn(
                  "relative flex items-center justify-center rounded-lg sm:rounded-xl font-black uppercase transition-all h-[min(2.7rem,5.6vh)] sm:h-[min(3.2rem,6.5vh)] md:h-[min(3.6rem,7vh)] text-xs min-[360px]:text-sm sm:text-base flex-1 max-w-[2.6rem] sm:max-w-[2.8rem] md:max-w-[3rem] shadow-sm active:scale-95 outline-none focus:outline-none",
                  {
